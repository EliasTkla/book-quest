...
export default function BookCard (props) {
    ...
    return (
        <Link className='book' key={book.id} to='/bookdetail' onClick={(e)=> {window.localStorage.setItem("scrollTo", e.target.offsetTop);}} state={{page: props.returnPage, id: book.id, title: bookTitle, author: bookAuthor, preview: previewLink, description: summary}}>
